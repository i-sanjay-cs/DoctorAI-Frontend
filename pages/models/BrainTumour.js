  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const generateResponse = await cohere.generate({
        prompt: `Start with : Hello, I am MediMate. and this is The response generated by the model and so consider this to Generate advice for the brain tumour condition: ${result.predicted_label}`,
      });
