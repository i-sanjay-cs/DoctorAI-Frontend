  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const generateResponse = await cohere.generate({
        prompt: `Start with: Hello, I am MediMate, and this is the response generated by the model. Please consider this to generate advice for the pneumonia condition: ${result.predicted_class_name}, Confidence: ${result.confidence_percentage.toFixed(2)}%.`,
      });
