  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const generateResponse = await cohere.generate({
        prompt: ` Start with : Hello, I am MediMate. and this is The response generated by the model and so consider this to  Generate a remedy and provide advice for the following bone fracture prediction: ${result.bone_type}, Result: ${result.result}`,
      });
