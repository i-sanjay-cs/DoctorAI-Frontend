...
const Tuberculosis = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch("https://6ad4-183-182-89-245.ngrok-free.app/predict-tuberculosis", {
        method: "POST",
        body: formData,
      });
      ...
      const generateResponse = await cohere.generate({
        prompt: `Start with : Hello, I am MediMate. and this is The response generated by the model and so consider this to Generate advice for the tuberculosis condition: ${result.predicted_class}, Confidence: ${result.confidence_percentage.toFixed(2)}%.`,
      });
